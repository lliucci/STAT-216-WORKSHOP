...
Let's take a look at what this looks like. Additionally, try to correct the error.
...
The `+` must be placed at the end of a line rather than at the beginning of a new one. Let's take a look at an example of this. Additionally, try to correct the error.
...
Let's take a look at an example of this. Fix the code by adding or removing parentheses.
...
Now, fill in the template below to create a plot with the duration of the roller coaster
ride on the x-axis and its maximum height on the y-axis.
(Hint: _Replace_ the underscores with the data set name and variable names.)
