...
### Characteristics of an Effective TA

Our overall goal in this course is to guide students through learning, understanding, and
appreciating Statistics. There are some general characteristics of effective teachers and tutors
that are important to keep in mind (adapted from ["Ten Characteristics of an Effective Tutor"](https://www.sac.edu/AcademicProgs/ScienceMathHealth/MathCenter/PDF/Tutor%20Training/Module%203/10%20Characteristics%20of%20a%20Good%20Tutor.pdf) by the Santa Ana College Math Center):

1. **Empathetic**. Understand what it's like to be a student who may lack confidence,
feel stressed, be overwhelmed or just not understand the material.

2. **Honest**. Don’t hesitate to say that you do not know about a particular concept.
Trying to bluff your way through will only hurt the student and your reputation in the long
run. 

3. **Enthusiastic**. Display a positive attitude and love for the subject that can rub off
on the students and help them enjoy learning the material.

4. **Good listener**. Develop and use good listening skills so that you will better
understand students' misconceptions and errors.

5. **Ask good, open-ended questions**. Ask probing questions in order to evaluate a
students' understanding. Try to get the student to answer their own questions by guiding them
through the steps. Giving students the opportunity to discover the answers themselves
will **encourage independence** and effective learning.

6. **Patient.** This is probably one of the most important characteristics of an effective TA.
Never act annoyed or judgmental that the student does not know something. Even if they ask the most basic
question, always demonstrate your patience. Try to remember how you felt when you first
started learning something new.

7. **Maintains confidentiality**. Any personal information such as medical conditions,
handicaps, test scores should be between you and the student. However, **all TAs are
"mandatory reporters" according to MSU policy**, which means you are legally obligated
to report discriminatory or harassing incidents. If you are concerned that this has occurred,
please talk to one of the Student Successes Coordinators or the Faculty Course Supervisor
for STAT 216. For more information, visit the [Office of Institutional Equity webpage](https://www.montana.edu/equity/index.html).

8. **Motivator**. Encourage students to strive to be the best they can, to reach their goals,
to recognize their strengths, to focus on learning _how_ to learn (metacognition) so that they will be
successful in the future.

9. **Allows for periods of silence**. Avoid feeling like you have to interrupt a moment of
silence by talking. Allow the student to reflect on the subject at hand before going on. 

10. **Shows respect for students as persons**. Try to understand their struggles.

11. **Maintains professional boundaries**. A TA is a professional and person of authority,
who represents the university.

12. **Can explain material in multiple ways**. Understand that not all students understand
concepts the same way and the first time; sense when students do not
understand and try another approach of presenting the material.
...
Delimiter: ","
chr (8): Age_Group, Coaster, Park, City, State, Type, Design, Inversions
dbl (7): Year_Opened, Top_Speed, Max_Height, Drop, Length, Duration, Num_of_Inversions
```
...
We will explore `catstats` later in this tutorial.
...
```{r warning = FALSE}
RollerCoasters %>% ggplot(mapping = aes(x = Year_Opened, y = Top_Speed, color = Type)) +
  geom_point()
...
One way to avoid this is to turn on "Rainbow Parentheses" by going to
...
* If it finds _no_ __identical match__, it will tell you that "`No documentation for ____ in specified packages and libraries:,`" and suggests you use a `??` instead.  
    ...
    + A `??` in front of the function name will search all of R for named functions __similar__ to what you typed.  
...
* Regardless of how you solve an issue outside of class, it is good practice to communicate your issue and how you resolved it with your team prior to class. As we mentioned before, **if you run into an issue, it is more than likely that students will run into the same problem**. Being prepared to encounter these issues and know how to help students fix them is a big part of your role as a Teaching Assistant.

$~$

**5. Further R Workshops**

There are a variety of other workshops which are co-organized by the Montana State University Library, Department of Mathematical Sciences, and Statistical Consulting and Research Services (SCRS, <https://www.montana.edu/statisticalconsulting/>).

This series of workshops are **free to all MSU Students and Employees**. They are created to help participants gain a better understanding of how to use R, Python, and apply their skills to other projects. This workshop was targeted to what a TA will typically encounter in STAT 216, but the other workshops are meant to help you learn R for personal and professional use in addition to/outside of STAT 216. More Information on upcoming workshops, you can go to [here](https://calendar.lib.montana.edu/calendar/workshops/?cid=707&t=d&d=0000-00-00&cal=707&ct=43429&inc=0)

More Information on these workshops and recordings of past sessions can be found [here](https://www.montana.edu/datascience/training/).
...
Research related to the development of these workshops appears in:

-   Theobold, A. S., Hancock, S. A., & Mannheimer, S. (2021). Designing Data Science Workshops for Data-Intensive Environmental Science Research, *Journal of Statistics Education*, 29(1), p. S83-S94. <https://doi.org/10.1080/10691898.2020.1854636>
