...
```{r IntroToRExercise1, exercise=T}
...
```{r ggplotTroubleshooting1, exercise = T, warning = F}
ggplot(data = Rollercoasters,
       mapping = aes(x = Design, y = Top_Speed)) + 
  geom_boxplot()
```

```{r ggplotTroubleshooting1-solution, warning = F}
ggplot(data = RollerCoasters,
       mapping = aes(x = Design, y = Top_Speed)) + 
  geom_boxplot()
```
...
```{r ggplotTroubleshooting2, exercise = T, warning = F}
ggplot(data = RollerCoasters,
       mapping = aes(x = Year_Opened))
  + geom_histogram()
```

```{r ggplotTroubleshooting2-solution, warning = F}
ggplot(data = RollerCoasters,
       mapping = aes(x = Year_Opened)) +
  geom_histogram()
```
...
```{r ggplotTroubleshooting3, exercise = T, warning = F}
ggplot(data = RollerCoasters,
       mapping = aes(x = Duration, y = Length))) +
  geom_point()
```

```{r ggplotTroubleshooting3-solution, warning = F}
ggplot(data = RollerCoasters,
       mapping = aes(x = Duration, y = Length)) +
  geom_point()
```
...
```{r ggplotTroubleshooting4, exercise = T, warning = F}
ggplot(data = ___,
...
```{r ggplotTroubleshooting4-solution, warning = F}
ggplot(data = RollerCoasters,
...
```{r catstatsExercise1, exercise=T}
one_proportion_test(
