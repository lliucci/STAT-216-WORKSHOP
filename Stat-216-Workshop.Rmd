...
-   "variable" : This one is pretty straight forward. When only dealing with one variable of interest, this is where the should put the name of the variable, **making sure to replicate how it appears in the dataset**. Pay attention to Capilatization and lowercase, underscores, and other potentially tricky formatting with variable names.
