...
If we want to get a summary of only a certain set of rows or columns from a dataset, we can write `[row,column]` after the dataset to get a subset of the data frame. The `View()` function can also be helpful to view the entire dataset.
...
Luckily, this information will always be here for you to reference if you have any specfic questions or just want a quick refresher.
