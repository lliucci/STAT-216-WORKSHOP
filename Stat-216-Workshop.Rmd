...
`catstats` is a package containing useful functions and data that is designed for Stat 217 and Stat 216. For more information, visit the [github repository for catstats](https://github.com/greenwood-stat/catstats).
