...
One of the most common issues that can come up when working with `ggplot` is data sets being misspelled. Let's take a look at what this looks like. Additionally, try to correct the error.
